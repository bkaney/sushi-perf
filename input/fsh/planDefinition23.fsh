...
Instance: HepBAdultForecastingPD23
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 23"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM23"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM23"
* name = "HepBAdultForecastingPDM23"
...
* action
  * title = "Hep B Immunization Forecast 23"
