...
Instance: HepBAdultForecastingPD4
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 4"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM4"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM4"
* name = "HepBAdultForecastingPDM4"
...
* action
  * title = "Hep B Immunization Forecast 4"
