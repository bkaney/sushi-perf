...
Instance: HepBAdultForecastingPD33
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 33"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM33"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM33"
* name = "HepBAdultForecastingPDM33"
...
* action
  * title = "Hep B Immunization Forecast 33"
