...
Instance: HepBAdultForecastingPD8
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 8"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM8"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM8"
* name = "HepBAdultForecastingPDM8"
...
* action
  * title = "Hep B Immunization Forecast 8"
