...
Instance: HepBAdultForecastingPD294
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 294"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM294"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM294"
* name = "HepBAdultForecastingPDM294"
...
* action
  * title = "Hep B Immunization Forecast 294"
