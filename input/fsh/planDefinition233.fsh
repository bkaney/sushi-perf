...
Instance: HepBAdultForecastingPD233
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 233"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM233"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM233"
* name = "HepBAdultForecastingPDM233"
...
* action
  * title = "Hep B Immunization Forecast 233"
