...
Instance: HepBAdultForecastingPD292
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 292"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM292"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM292"
* name = "HepBAdultForecastingPDM292"
...
* action
  * title = "Hep B Immunization Forecast 292"
