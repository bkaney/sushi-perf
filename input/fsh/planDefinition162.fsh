...
Instance: HepBAdultForecastingPD162
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 162"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM162"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM162"
* name = "HepBAdultForecastingPDM162"
...
* action
  * title = "Hep B Immunization Forecast 162"
