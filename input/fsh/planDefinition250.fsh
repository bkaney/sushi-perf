...
Instance: HepBAdultForecastingPD250
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 250"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM250"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM250"
* name = "HepBAdultForecastingPDM250"
...
* action
  * title = "Hep B Immunization Forecast 250"
