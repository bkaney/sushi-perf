...
Instance: HepBAdultForecastingPD118
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 118"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM118"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM118"
* name = "HepBAdultForecastingPDM118"
...
* action
  * title = "Hep B Immunization Forecast 118"
