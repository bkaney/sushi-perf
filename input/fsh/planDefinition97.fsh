...
Instance: HepBAdultForecastingPD97
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 97"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM97"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM97"
* name = "HepBAdultForecastingPDM97"
...
* action
  * title = "Hep B Immunization Forecast 97"
