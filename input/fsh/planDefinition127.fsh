...
Instance: HepBAdultForecastingPD127
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 127"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM127"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM127"
* name = "HepBAdultForecastingPDM127"
...
* action
  * title = "Hep B Immunization Forecast 127"
