...
Instance: HepBAdultForecastingPD186
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 186"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM186"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM186"
* name = "HepBAdultForecastingPDM186"
...
* action
  * title = "Hep B Immunization Forecast 186"
