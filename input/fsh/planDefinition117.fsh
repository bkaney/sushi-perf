...
Instance: HepBAdultForecastingPD117
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 117"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM117"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM117"
* name = "HepBAdultForecastingPDM117"
...
* action
  * title = "Hep B Immunization Forecast 117"
