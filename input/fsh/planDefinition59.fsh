...
Instance: HepBAdultForecastingPD59
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 59"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM59"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM59"
* name = "HepBAdultForecastingPDM59"
...
* action
  * title = "Hep B Immunization Forecast 59"
