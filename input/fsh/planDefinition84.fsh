...
Instance: HepBAdultForecastingPD84
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 84"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM84"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM84"
* name = "HepBAdultForecastingPDM84"
...
* action
  * title = "Hep B Immunization Forecast 84"
