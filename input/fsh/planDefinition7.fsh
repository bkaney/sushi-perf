...
Instance: HepBAdultForecastingPD7
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 7"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM7"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM7"
* name = "HepBAdultForecastingPDM7"
...
* action
  * title = "Hep B Immunization Forecast 7"
