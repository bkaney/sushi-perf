...
Instance: HepBAdultForecastingPD14
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 14"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM14"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM14"
* name = "HepBAdultForecastingPDM14"
...
* action
  * title = "Hep B Immunization Forecast 14"
