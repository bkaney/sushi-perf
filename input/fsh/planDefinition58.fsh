...
Instance: HepBAdultForecastingPD58
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 58"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM58"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM58"
* name = "HepBAdultForecastingPDM58"
...
* action
  * title = "Hep B Immunization Forecast 58"
