...
Instance: HepBAdultForecastingPD163
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 163"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM163"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM163"
* name = "HepBAdultForecastingPDM163"
...
* action
  * title = "Hep B Immunization Forecast 163"
