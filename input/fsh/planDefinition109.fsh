...
Instance: HepBAdultForecastingPD109
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 109"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM109"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM109"
* name = "HepBAdultForecastingPDM109"
...
* action
  * title = "Hep B Immunization Forecast 109"
