...
Instance: HepBAdultForecastingPD290
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 290"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM290"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM290"
* name = "HepBAdultForecastingPDM290"
...
* action
  * title = "Hep B Immunization Forecast 290"
