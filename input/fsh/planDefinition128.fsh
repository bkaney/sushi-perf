...
Instance: HepBAdultForecastingPD128
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 128"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM128"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM128"
* name = "HepBAdultForecastingPDM128"
...
* action
  * title = "Hep B Immunization Forecast 128"
