...
Instance: HepBAdultForecastingPD37
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 37"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM37"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM37"
* name = "HepBAdultForecastingPDM37"
...
* action
  * title = "Hep B Immunization Forecast 37"
