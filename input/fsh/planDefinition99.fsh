...
Instance: HepBAdultForecastingPD99
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 99"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM99"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM99"
* name = "HepBAdultForecastingPDM99"
...
* action
  * title = "Hep B Immunization Forecast 99"
