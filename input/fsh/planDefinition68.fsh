...
Instance: HepBAdultForecastingPD68
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 68"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM68"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM68"
* name = "HepBAdultForecastingPDM68"
...
* action
  * title = "Hep B Immunization Forecast 68"
