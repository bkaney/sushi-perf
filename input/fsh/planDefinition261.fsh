...
Instance: HepBAdultForecastingPD261
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 261"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM261"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM261"
* name = "HepBAdultForecastingPDM261"
...
* action
  * title = "Hep B Immunization Forecast 261"
