...
Instance: HepBAdultForecastingPD32
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 32"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM32"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM32"
* name = "HepBAdultForecastingPDM32"
...
* action
  * title = "Hep B Immunization Forecast 32"
