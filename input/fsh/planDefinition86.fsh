...
Instance: HepBAdultForecastingPD86
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 86"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM86"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM86"
* name = "HepBAdultForecastingPDM86"
...
* action
  * title = "Hep B Immunization Forecast 86"
