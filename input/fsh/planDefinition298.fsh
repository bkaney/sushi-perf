...
Instance: HepBAdultForecastingPD298
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 298"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM298"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM298"
* name = "HepBAdultForecastingPDM298"
...
* action
  * title = "Hep B Immunization Forecast 298"
