...
Instance: HepBAdultForecastingPD133
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 133"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM133"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM133"
* name = "HepBAdultForecastingPDM133"
...
* action
  * title = "Hep B Immunization Forecast 133"
