...
Instance: HepBAdultForecastingPD170
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 170"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM170"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM170"
* name = "HepBAdultForecastingPDM170"
...
* action
  * title = "Hep B Immunization Forecast 170"
