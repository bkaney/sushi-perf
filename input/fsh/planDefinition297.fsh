...
Instance: HepBAdultForecastingPD297
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 297"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM297"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM297"
* name = "HepBAdultForecastingPDM297"
...
* action
  * title = "Hep B Immunization Forecast 297"
