...
Instance: HepBAdultForecastingPD222
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 222"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM222"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM222"
* name = "HepBAdultForecastingPDM222"
...
* action
  * title = "Hep B Immunization Forecast 222"
