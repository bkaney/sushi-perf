...
Instance: HepBAdultForecastingPD36
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 36"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM36"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM36"
* name = "HepBAdultForecastingPDM36"
...
* action
  * title = "Hep B Immunization Forecast 36"
