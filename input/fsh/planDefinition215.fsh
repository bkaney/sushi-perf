...
Instance: HepBAdultForecastingPD215
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 215"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM215"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM215"
* name = "HepBAdultForecastingPDM215"
...
* action
  * title = "Hep B Immunization Forecast 215"
