...
Instance: HepBAdultForecastingPD126
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 126"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM126"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM126"
* name = "HepBAdultForecastingPDM126"
...
* action
  * title = "Hep B Immunization Forecast 126"
