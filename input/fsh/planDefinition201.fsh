...
Instance: HepBAdultForecastingPD201
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 201"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM201"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM201"
* name = "HepBAdultForecastingPDM201"
...
* action
  * title = "Hep B Immunization Forecast 201"
