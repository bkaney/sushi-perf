...
Instance: HepBAdultForecastingPD266
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 266"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM266"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM266"
* name = "HepBAdultForecastingPDM266"
...
* action
  * title = "Hep B Immunization Forecast 266"
