...
Instance: HepBAdultForecastingPD134
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 134"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM134"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM134"
* name = "HepBAdultForecastingPDM134"
...
* action
  * title = "Hep B Immunization Forecast 134"
