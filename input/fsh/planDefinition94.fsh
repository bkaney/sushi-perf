...
Instance: HepBAdultForecastingPD94
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 94"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM94"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM94"
* name = "HepBAdultForecastingPDM94"
...
* action
  * title = "Hep B Immunization Forecast 94"
