...
Instance: HepBAdultForecastingPD175
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 175"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM175"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM175"
* name = "HepBAdultForecastingPDM175"
...
* action
  * title = "Hep B Immunization Forecast 175"
