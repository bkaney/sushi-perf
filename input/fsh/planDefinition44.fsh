...
Instance: HepBAdultForecastingPD44
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 44"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM44"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM44"
* name = "HepBAdultForecastingPDM44"
...
* action
  * title = "Hep B Immunization Forecast 44"
