...
Instance: HepBAdultForecastingPD75
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 75"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM75"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM75"
* name = "HepBAdultForecastingPDM75"
...
* action
  * title = "Hep B Immunization Forecast 75"
