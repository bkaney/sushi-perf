...
Instance: HepBAdultForecastingPD114
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 114"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM114"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM114"
* name = "HepBAdultForecastingPDM114"
...
* action
  * title = "Hep B Immunization Forecast 114"
