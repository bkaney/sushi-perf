...
Instance: HepBAdultForecastingPD132
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 132"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM132"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM132"
* name = "HepBAdultForecastingPDM132"
...
* action
  * title = "Hep B Immunization Forecast 132"
