...
Instance: HepBAdultForecastingPD258
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 258"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM258"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM258"
* name = "HepBAdultForecastingPDM258"
...
* action
  * title = "Hep B Immunization Forecast 258"
