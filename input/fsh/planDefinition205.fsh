...
Instance: HepBAdultForecastingPD205
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 205"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM205"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM205"
* name = "HepBAdultForecastingPDM205"
...
* action
  * title = "Hep B Immunization Forecast 205"
