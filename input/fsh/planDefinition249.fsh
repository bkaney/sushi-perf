...
Instance: HepBAdultForecastingPD249
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 249"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM249"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM249"
* name = "HepBAdultForecastingPDM249"
...
* action
  * title = "Hep B Immunization Forecast 249"
