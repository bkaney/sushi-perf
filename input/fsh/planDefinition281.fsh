...
Instance: HepBAdultForecastingPD281
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 281"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM281"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM281"
* name = "HepBAdultForecastingPDM281"
...
* action
  * title = "Hep B Immunization Forecast 281"
