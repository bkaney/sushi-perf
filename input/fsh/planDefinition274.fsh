...
Instance: HepBAdultForecastingPD274
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 274"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM274"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM274"
* name = "HepBAdultForecastingPDM274"
...
* action
  * title = "Hep B Immunization Forecast 274"
