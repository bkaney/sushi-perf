...
Instance: HepBAdultForecastingPD55
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 55"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM55"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM55"
* name = "HepBAdultForecastingPDM55"
...
* action
  * title = "Hep B Immunization Forecast 55"
