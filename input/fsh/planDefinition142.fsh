...
Instance: HepBAdultForecastingPD142
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 142"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM142"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM142"
* name = "HepBAdultForecastingPDM142"
...
* action
  * title = "Hep B Immunization Forecast 142"
