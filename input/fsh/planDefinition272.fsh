...
Instance: HepBAdultForecastingPD272
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 272"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM272"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM272"
* name = "HepBAdultForecastingPDM272"
...
* action
  * title = "Hep B Immunization Forecast 272"
