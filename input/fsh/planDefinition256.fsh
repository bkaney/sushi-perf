...
Instance: HepBAdultForecastingPD256
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 256"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM256"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM256"
* name = "HepBAdultForecastingPDM256"
...
* action
  * title = "Hep B Immunization Forecast 256"
