...
Instance: HepBAdultForecastingPD92
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 92"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM92"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM92"
* name = "HepBAdultForecastingPDM92"
...
* action
  * title = "Hep B Immunization Forecast 92"
