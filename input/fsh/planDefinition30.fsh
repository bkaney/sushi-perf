...
Instance: HepBAdultForecastingPD30
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 30"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM30"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM30"
* name = "HepBAdultForecastingPDM30"
...
* action
  * title = "Hep B Immunization Forecast 30"
