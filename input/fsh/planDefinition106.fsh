...
Instance: HepBAdultForecastingPD106
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 106"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM106"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM106"
* name = "HepBAdultForecastingPDM106"
...
* action
  * title = "Hep B Immunization Forecast 106"
