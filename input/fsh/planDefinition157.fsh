...
Instance: HepBAdultForecastingPD157
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 157"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM157"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM157"
* name = "HepBAdultForecastingPDM157"
...
* action
  * title = "Hep B Immunization Forecast 157"
