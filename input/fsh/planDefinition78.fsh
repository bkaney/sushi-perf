...
Instance: HepBAdultForecastingPD78
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 78"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM78"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM78"
* name = "HepBAdultForecastingPDM78"
...
* action
  * title = "Hep B Immunization Forecast 78"
