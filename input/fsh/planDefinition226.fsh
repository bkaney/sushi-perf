...
Instance: HepBAdultForecastingPD226
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 226"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM226"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM226"
* name = "HepBAdultForecastingPDM226"
...
* action
  * title = "Hep B Immunization Forecast 226"
