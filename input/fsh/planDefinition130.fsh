...
Instance: HepBAdultForecastingPD130
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 130"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM130"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM130"
* name = "HepBAdultForecastingPDM130"
...
* action
  * title = "Hep B Immunization Forecast 130"
