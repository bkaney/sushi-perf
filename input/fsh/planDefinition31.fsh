...
Instance: HepBAdultForecastingPD31
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 31"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM31"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM31"
* name = "HepBAdultForecastingPDM31"
...
* action
  * title = "Hep B Immunization Forecast 31"
