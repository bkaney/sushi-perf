...
Instance: HepBAdultForecastingPD181
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 181"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM181"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM181"
* name = "HepBAdultForecastingPDM181"
...
* action
  * title = "Hep B Immunization Forecast 181"
