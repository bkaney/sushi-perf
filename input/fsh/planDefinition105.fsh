...
Instance: HepBAdultForecastingPD105
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 105"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM105"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM105"
* name = "HepBAdultForecastingPDM105"
...
* action
  * title = "Hep B Immunization Forecast 105"
