...
Instance: HepBAdultForecastingPD13
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 13"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM13"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM13"
* name = "HepBAdultForecastingPDM13"
...
* action
  * title = "Hep B Immunization Forecast 13"
