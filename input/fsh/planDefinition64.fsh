...
Instance: HepBAdultForecastingPD64
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 64"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM64"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM64"
* name = "HepBAdultForecastingPDM64"
...
* action
  * title = "Hep B Immunization Forecast 64"
