...
Instance: HepBAdultForecastingPD147
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 147"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM147"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM147"
* name = "HepBAdultForecastingPDM147"
...
* action
  * title = "Hep B Immunization Forecast 147"
