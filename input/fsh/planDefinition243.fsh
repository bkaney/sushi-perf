...
Instance: HepBAdultForecastingPD243
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 243"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM243"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM243"
* name = "HepBAdultForecastingPDM243"
...
* action
  * title = "Hep B Immunization Forecast 243"
