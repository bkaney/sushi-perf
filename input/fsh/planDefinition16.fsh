...
Instance: HepBAdultForecastingPD16
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 16"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM16"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM16"
* name = "HepBAdultForecastingPDM16"
...
* action
  * title = "Hep B Immunization Forecast 16"
