...
Instance: HepBAdultForecastingPD43
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 43"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM43"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM43"
* name = "HepBAdultForecastingPDM43"
...
* action
  * title = "Hep B Immunization Forecast 43"
