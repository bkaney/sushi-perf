...
Instance: HepBAdultForecastingPD47
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 47"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM47"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM47"
* name = "HepBAdultForecastingPDM47"
...
* action
  * title = "Hep B Immunization Forecast 47"
