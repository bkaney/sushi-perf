...
Instance: HepBAdultForecastingPD12
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 12"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM12"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM12"
* name = "HepBAdultForecastingPDM12"
...
* action
  * title = "Hep B Immunization Forecast 12"
