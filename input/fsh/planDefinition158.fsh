...
Instance: HepBAdultForecastingPD158
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 158"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM158"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM158"
* name = "HepBAdultForecastingPDM158"
...
* action
  * title = "Hep B Immunization Forecast 158"
