...
Instance: HepBAdultForecastingPD150
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 150"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM150"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM150"
* name = "HepBAdultForecastingPDM150"
...
* action
  * title = "Hep B Immunization Forecast 150"
