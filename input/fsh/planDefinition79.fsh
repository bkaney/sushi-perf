...
Instance: HepBAdultForecastingPD79
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 79"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM79"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM79"
* name = "HepBAdultForecastingPDM79"
...
* action
  * title = "Hep B Immunization Forecast 79"
