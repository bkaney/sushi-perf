...
Instance: HepBAdultForecastingPD54
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 54"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM54"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM54"
* name = "HepBAdultForecastingPDM54"
...
* action
  * title = "Hep B Immunization Forecast 54"
