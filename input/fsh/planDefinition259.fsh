...
Instance: HepBAdultForecastingPD259
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 259"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM259"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM259"
* name = "HepBAdultForecastingPDM259"
...
* action
  * title = "Hep B Immunization Forecast 259"
