...
Instance: HepBAdultForecastingPD161
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 161"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM161"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM161"
* name = "HepBAdultForecastingPDM161"
...
* action
  * title = "Hep B Immunization Forecast 161"
