...
Instance: HepBAdultForecastingPD145
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 145"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM145"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM145"
* name = "HepBAdultForecastingPDM145"
...
* action
  * title = "Hep B Immunization Forecast 145"
