...
Instance: HepBAdultForecastingPD159
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 159"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM159"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM159"
* name = "HepBAdultForecastingPDM159"
...
* action
  * title = "Hep B Immunization Forecast 159"
