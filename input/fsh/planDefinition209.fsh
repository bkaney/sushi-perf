...
Instance: HepBAdultForecastingPD209
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 209"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM209"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM209"
* name = "HepBAdultForecastingPDM209"
...
* action
  * title = "Hep B Immunization Forecast 209"
