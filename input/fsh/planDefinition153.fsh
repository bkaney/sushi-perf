...
Instance: HepBAdultForecastingPD153
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 153"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM153"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM153"
* name = "HepBAdultForecastingPDM153"
...
* action
  * title = "Hep B Immunization Forecast 153"
