...
Instance: HepBAdultForecastingPD273
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 273"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM273"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM273"
* name = "HepBAdultForecastingPDM273"
...
* action
  * title = "Hep B Immunization Forecast 273"
