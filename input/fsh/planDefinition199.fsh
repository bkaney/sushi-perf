...
Instance: HepBAdultForecastingPD199
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 199"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM199"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM199"
* name = "HepBAdultForecastingPDM199"
...
* action
  * title = "Hep B Immunization Forecast 199"
