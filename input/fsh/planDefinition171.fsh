...
Instance: HepBAdultForecastingPD171
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 171"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM171"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM171"
* name = "HepBAdultForecastingPDM171"
...
* action
  * title = "Hep B Immunization Forecast 171"
