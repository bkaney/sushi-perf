...
Instance: HepBAdultForecastingPD111
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 111"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM111"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM111"
* name = "HepBAdultForecastingPDM111"
...
* action
  * title = "Hep B Immunization Forecast 111"
