...
Instance: HepBAdultForecastingPD225
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 225"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM225"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM225"
* name = "HepBAdultForecastingPDM225"
...
* action
  * title = "Hep B Immunization Forecast 225"
