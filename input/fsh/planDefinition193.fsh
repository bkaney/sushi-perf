...
Instance: HepBAdultForecastingPD193
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 193"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM193"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM193"
* name = "HepBAdultForecastingPDM193"
...
* action
  * title = "Hep B Immunization Forecast 193"
