...
Instance: HepBAdultForecastingPD124
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 124"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM124"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM124"
* name = "HepBAdultForecastingPDM124"
...
* action
  * title = "Hep B Immunization Forecast 124"
