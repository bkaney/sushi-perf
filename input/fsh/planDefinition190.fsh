...
Instance: HepBAdultForecastingPD190
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 190"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM190"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM190"
* name = "HepBAdultForecastingPDM190"
...
* action
  * title = "Hep B Immunization Forecast 190"
