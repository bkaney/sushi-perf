...
Instance: HepBAdultForecastingPD113
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 113"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM113"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM113"
* name = "HepBAdultForecastingPDM113"
...
* action
  * title = "Hep B Immunization Forecast 113"
