...
Instance: HepBAdultForecastingPD177
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 177"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM177"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM177"
* name = "HepBAdultForecastingPDM177"
...
* action
  * title = "Hep B Immunization Forecast 177"
