...
Instance: HepBAdultForecastingPD179
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 179"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM179"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM179"
* name = "HepBAdultForecastingPDM179"
...
* action
  * title = "Hep B Immunization Forecast 179"
