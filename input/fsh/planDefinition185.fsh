...
Instance: HepBAdultForecastingPD185
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 185"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM185"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM185"
* name = "HepBAdultForecastingPDM185"
...
* action
  * title = "Hep B Immunization Forecast 185"
