...
Instance: HepBAdultForecastingPD71
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 71"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM71"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM71"
* name = "HepBAdultForecastingPDM71"
...
* action
  * title = "Hep B Immunization Forecast 71"
