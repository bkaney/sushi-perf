...
Instance: HepBAdultForecastingPD263
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 263"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM263"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM263"
* name = "HepBAdultForecastingPDM263"
...
* action
  * title = "Hep B Immunization Forecast 263"
