...
Instance: HepBAdultForecastingPD172
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 172"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM172"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM172"
* name = "HepBAdultForecastingPDM172"
...
* action
  * title = "Hep B Immunization Forecast 172"
