...
Instance: HepBAdultForecastingPD236
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 236"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM236"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM236"
* name = "HepBAdultForecastingPDM236"
...
* action
  * title = "Hep B Immunization Forecast 236"
