...
Instance: HepBAdultForecastingPD144
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 144"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM144"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM144"
* name = "HepBAdultForecastingPDM144"
...
* action
  * title = "Hep B Immunization Forecast 144"
