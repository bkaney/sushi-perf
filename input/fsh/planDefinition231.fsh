...
Instance: HepBAdultForecastingPD231
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 231"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM231"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM231"
* name = "HepBAdultForecastingPDM231"
...
* action
  * title = "Hep B Immunization Forecast 231"
