...
Instance: HepBAdultForecastingPD42
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 42"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM42"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM42"
* name = "HepBAdultForecastingPDM42"
...
* action
  * title = "Hep B Immunization Forecast 42"
