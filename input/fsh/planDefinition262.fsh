...
Instance: HepBAdultForecastingPD262
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 262"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM262"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM262"
* name = "HepBAdultForecastingPDM262"
...
* action
  * title = "Hep B Immunization Forecast 262"
