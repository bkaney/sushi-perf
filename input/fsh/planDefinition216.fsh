...
Instance: HepBAdultForecastingPD216
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 216"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM216"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM216"
* name = "HepBAdultForecastingPDM216"
...
* action
  * title = "Hep B Immunization Forecast 216"
