...
Instance: HepBAdultForecastingPD2
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 2"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM2"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM2"
* name = "HepBAdultForecastingPDM2"
...
* action
  * title = "Hep B Immunization Forecast 2"
