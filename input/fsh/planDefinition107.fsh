...
Instance: HepBAdultForecastingPD107
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 107"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM107"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM107"
* name = "HepBAdultForecastingPDM107"
...
* action
  * title = "Hep B Immunization Forecast 107"
