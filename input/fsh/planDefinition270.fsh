...
Instance: HepBAdultForecastingPD270
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 270"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM270"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM270"
* name = "HepBAdultForecastingPDM270"
...
* action
  * title = "Hep B Immunization Forecast 270"
