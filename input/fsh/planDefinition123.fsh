...
Instance: HepBAdultForecastingPD123
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 123"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM123"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM123"
* name = "HepBAdultForecastingPDM123"
...
* action
  * title = "Hep B Immunization Forecast 123"
