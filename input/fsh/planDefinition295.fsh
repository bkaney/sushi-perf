...
Instance: HepBAdultForecastingPD295
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 295"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM295"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM295"
* name = "HepBAdultForecastingPDM295"
...
* action
  * title = "Hep B Immunization Forecast 295"
