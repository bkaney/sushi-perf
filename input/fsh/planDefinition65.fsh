...
Instance: HepBAdultForecastingPD65
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 65"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM65"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM65"
* name = "HepBAdultForecastingPDM65"
...
* action
  * title = "Hep B Immunization Forecast 65"
