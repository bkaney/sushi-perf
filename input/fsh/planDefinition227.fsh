...
Instance: HepBAdultForecastingPD227
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 227"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM227"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM227"
* name = "HepBAdultForecastingPDM227"
...
* action
  * title = "Hep B Immunization Forecast 227"
