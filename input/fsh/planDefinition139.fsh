...
Instance: HepBAdultForecastingPD139
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 139"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM139"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM139"
* name = "HepBAdultForecastingPDM139"
...
* action
  * title = "Hep B Immunization Forecast 139"
