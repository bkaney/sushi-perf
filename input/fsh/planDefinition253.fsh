...
Instance: HepBAdultForecastingPD253
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 253"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM253"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM253"
* name = "HepBAdultForecastingPDM253"
...
* action
  * title = "Hep B Immunization Forecast 253"
