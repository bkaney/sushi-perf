...
Instance: HepBAdultForecastingPD21
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 21"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM21"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM21"
* name = "HepBAdultForecastingPDM21"
...
* action
  * title = "Hep B Immunization Forecast 21"
