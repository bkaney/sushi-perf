...
Instance: HepBAdultForecastingPD296
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 296"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM296"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM296"
* name = "HepBAdultForecastingPDM296"
...
* action
  * title = "Hep B Immunization Forecast 296"
