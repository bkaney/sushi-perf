...
Instance: HepBAdultForecastingPD229
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 229"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM229"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM229"
* name = "HepBAdultForecastingPDM229"
...
* action
  * title = "Hep B Immunization Forecast 229"
