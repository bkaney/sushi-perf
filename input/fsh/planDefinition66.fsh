...
Instance: HepBAdultForecastingPD66
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 66"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM66"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM66"
* name = "HepBAdultForecastingPDM66"
...
* action
  * title = "Hep B Immunization Forecast 66"
