...
Instance: HepBAdultForecastingPD115
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 115"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM115"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM115"
* name = "HepBAdultForecastingPDM115"
...
* action
  * title = "Hep B Immunization Forecast 115"
