...
Instance: HepBAdultForecastingPD283
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 283"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM283"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM283"
* name = "HepBAdultForecastingPDM283"
...
* action
  * title = "Hep B Immunization Forecast 283"
