...
Instance: HepBAdultForecastingPD285
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 285"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM285"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM285"
* name = "HepBAdultForecastingPDM285"
...
* action
  * title = "Hep B Immunization Forecast 285"
