...
Instance: HepBAdultForecastingPD77
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 77"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM77"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM77"
* name = "HepBAdultForecastingPDM77"
...
* action
  * title = "Hep B Immunization Forecast 77"
