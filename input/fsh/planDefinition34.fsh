...
Instance: HepBAdultForecastingPD34
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 34"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM34"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM34"
* name = "HepBAdultForecastingPDM34"
...
* action
  * title = "Hep B Immunization Forecast 34"
