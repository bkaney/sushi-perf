...
Instance: HepBAdultForecastingPD169
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 169"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM169"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM169"
* name = "HepBAdultForecastingPDM169"
...
* action
  * title = "Hep B Immunization Forecast 169"
