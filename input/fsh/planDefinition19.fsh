...
Instance: HepBAdultForecastingPD19
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 19"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM19"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM19"
* name = "HepBAdultForecastingPDM19"
...
* action
  * title = "Hep B Immunization Forecast 19"
