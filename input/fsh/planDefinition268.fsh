...
Instance: HepBAdultForecastingPD268
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 268"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM268"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM268"
* name = "HepBAdultForecastingPDM268"
...
* action
  * title = "Hep B Immunization Forecast 268"
