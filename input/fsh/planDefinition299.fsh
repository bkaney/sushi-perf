...
Instance: HepBAdultForecastingPD299
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 299"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM299"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM299"
* name = "HepBAdultForecastingPDM299"
...
* action
  * title = "Hep B Immunization Forecast 299"
