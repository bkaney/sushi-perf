...
Instance: HepBAdultForecastingPD62
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 62"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM62"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM62"
* name = "HepBAdultForecastingPDM62"
...
* action
  * title = "Hep B Immunization Forecast 62"
