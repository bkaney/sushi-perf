...
Instance: HepBAdultForecastingPD242
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 242"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM242"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM242"
* name = "HepBAdultForecastingPDM242"
...
* action
  * title = "Hep B Immunization Forecast 242"
