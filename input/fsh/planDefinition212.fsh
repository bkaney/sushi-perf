...
Instance: HepBAdultForecastingPD212
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 212"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM212"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM212"
* name = "HepBAdultForecastingPDM212"
...
* action
  * title = "Hep B Immunization Forecast 212"
