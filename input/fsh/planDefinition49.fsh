...
Instance: HepBAdultForecastingPD49
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 49"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM49"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM49"
* name = "HepBAdultForecastingPDM49"
...
* action
  * title = "Hep B Immunization Forecast 49"
