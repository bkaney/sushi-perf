...
Instance: HepBAdultForecastingPD1
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 1"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM1"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM1"
* name = "HepBAdultForecastingPDM1"
...
* action
  * title = "Hep B Immunization Forecast 1"
