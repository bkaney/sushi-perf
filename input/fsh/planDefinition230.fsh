...
Instance: HepBAdultForecastingPD230
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 230"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM230"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM230"
* name = "HepBAdultForecastingPDM230"
...
* action
  * title = "Hep B Immunization Forecast 230"
