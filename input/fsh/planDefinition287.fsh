...
Instance: HepBAdultForecastingPD287
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 287"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM287"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM287"
* name = "HepBAdultForecastingPDM287"
...
* action
  * title = "Hep B Immunization Forecast 287"
