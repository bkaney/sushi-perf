...
Instance: HepBAdultForecastingPD57
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 57"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM57"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM57"
* name = "HepBAdultForecastingPDM57"
...
* action
  * title = "Hep B Immunization Forecast 57"
