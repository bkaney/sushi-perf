...
Instance: HepBAdultForecastingPD280
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 280"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM280"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM280"
* name = "HepBAdultForecastingPDM280"
...
* action
  * title = "Hep B Immunization Forecast 280"
