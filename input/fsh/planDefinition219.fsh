...
Instance: HepBAdultForecastingPD219
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 219"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM219"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM219"
* name = "HepBAdultForecastingPDM219"
...
* action
  * title = "Hep B Immunization Forecast 219"
