...
Instance: HepBAdultForecastingPD141
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 141"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM141"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM141"
* name = "HepBAdultForecastingPDM141"
...
* action
  * title = "Hep B Immunization Forecast 141"
