...
Instance: HepBAdultForecastingPD240
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 240"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM240"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM240"
* name = "HepBAdultForecastingPDM240"
...
* action
  * title = "Hep B Immunization Forecast 240"
