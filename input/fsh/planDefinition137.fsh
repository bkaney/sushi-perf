...
Instance: HepBAdultForecastingPD137
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 137"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM137"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM137"
* name = "HepBAdultForecastingPDM137"
...
* action
  * title = "Hep B Immunization Forecast 137"
