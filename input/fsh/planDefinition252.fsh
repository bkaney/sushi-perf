...
Instance: HepBAdultForecastingPD252
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 252"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM252"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM252"
* name = "HepBAdultForecastingPDM252"
...
* action
  * title = "Hep B Immunization Forecast 252"
