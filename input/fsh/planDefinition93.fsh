...
Instance: HepBAdultForecastingPD93
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 93"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM93"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM93"
* name = "HepBAdultForecastingPDM93"
...
* action
  * title = "Hep B Immunization Forecast 93"
