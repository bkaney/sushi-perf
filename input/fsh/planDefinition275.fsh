...
Instance: HepBAdultForecastingPD275
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 275"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM275"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM275"
* name = "HepBAdultForecastingPDM275"
...
* action
  * title = "Hep B Immunization Forecast 275"
