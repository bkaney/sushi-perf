...
Instance: HepBAdultForecastingPD112
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 112"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM112"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM112"
* name = "HepBAdultForecastingPDM112"
...
* action
  * title = "Hep B Immunization Forecast 112"
