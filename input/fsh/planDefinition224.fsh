...
Instance: HepBAdultForecastingPD224
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 224"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM224"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM224"
* name = "HepBAdultForecastingPDM224"
...
* action
  * title = "Hep B Immunization Forecast 224"
