...
Instance: HepBAdultForecastingPD210
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 210"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM210"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM210"
* name = "HepBAdultForecastingPDM210"
...
* action
  * title = "Hep B Immunization Forecast 210"
