...
Instance: HepBAdultForecastingPD129
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 129"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM129"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM129"
* name = "HepBAdultForecastingPDM129"
...
* action
  * title = "Hep B Immunization Forecast 129"
