...
Instance: HepBAdultForecastingPD156
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 156"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM156"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM156"
* name = "HepBAdultForecastingPDM156"
...
* action
  * title = "Hep B Immunization Forecast 156"
