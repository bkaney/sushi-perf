...
Instance: HepBAdultForecastingPD91
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 91"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM91"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM91"
* name = "HepBAdultForecastingPDM91"
...
* action
  * title = "Hep B Immunization Forecast 91"
