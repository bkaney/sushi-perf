...
Instance: HepBAdultForecastingPD207
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 207"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM207"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM207"
* name = "HepBAdultForecastingPDM207"
...
* action
  * title = "Hep B Immunization Forecast 207"
