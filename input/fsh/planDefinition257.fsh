...
Instance: HepBAdultForecastingPD257
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 257"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM257"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM257"
* name = "HepBAdultForecastingPDM257"
...
* action
  * title = "Hep B Immunization Forecast 257"
