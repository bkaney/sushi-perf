...
Instance: HepBAdultForecastingPD25
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 25"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM25"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM25"
* name = "HepBAdultForecastingPDM25"
...
* action
  * title = "Hep B Immunization Forecast 25"
