...
Instance: HepBAdultForecastingPD184
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 184"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM184"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM184"
* name = "HepBAdultForecastingPDM184"
...
* action
  * title = "Hep B Immunization Forecast 184"
