...
Instance: HepBAdultForecastingPD73
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 73"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM73"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM73"
* name = "HepBAdultForecastingPDM73"
...
* action
  * title = "Hep B Immunization Forecast 73"
