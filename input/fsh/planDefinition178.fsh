...
Instance: HepBAdultForecastingPD178
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 178"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM178"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM178"
* name = "HepBAdultForecastingPDM178"
...
* action
  * title = "Hep B Immunization Forecast 178"
