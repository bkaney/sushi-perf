...
Instance: HepBAdultForecastingPD3
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 3"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM3"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM3"
* name = "HepBAdultForecastingPDM3"
...
* action
  * title = "Hep B Immunization Forecast 3"
