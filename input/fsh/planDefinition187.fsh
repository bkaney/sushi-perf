...
Instance: HepBAdultForecastingPD187
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 187"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM187"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM187"
* name = "HepBAdultForecastingPDM187"
...
* action
  * title = "Hep B Immunization Forecast 187"
