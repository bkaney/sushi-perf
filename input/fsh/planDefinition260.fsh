...
Instance: HepBAdultForecastingPD260
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 260"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM260"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM260"
* name = "HepBAdultForecastingPDM260"
...
* action
  * title = "Hep B Immunization Forecast 260"
