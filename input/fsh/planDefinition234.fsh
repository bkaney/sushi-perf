...
Instance: HepBAdultForecastingPD234
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 234"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM234"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM234"
* name = "HepBAdultForecastingPDM234"
...
* action
  * title = "Hep B Immunization Forecast 234"
