...
Instance: HepBAdultForecastingPD289
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 289"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM289"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM289"
* name = "HepBAdultForecastingPDM289"
...
* action
  * title = "Hep B Immunization Forecast 289"
