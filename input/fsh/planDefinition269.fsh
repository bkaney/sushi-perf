...
Instance: HepBAdultForecastingPD269
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 269"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM269"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM269"
* name = "HepBAdultForecastingPDM269"
...
* action
  * title = "Hep B Immunization Forecast 269"
