...
Instance: HepBAdultForecastingPD104
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 104"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM104"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM104"
* name = "HepBAdultForecastingPDM104"
...
* action
  * title = "Hep B Immunization Forecast 104"
