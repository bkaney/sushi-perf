...
Instance: HepBAdultForecastingPD164
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 164"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM164"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM164"
* name = "HepBAdultForecastingPDM164"
...
* action
  * title = "Hep B Immunization Forecast 164"
