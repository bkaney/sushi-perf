...
Instance: HepBAdultForecastingPD41
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 41"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM41"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM41"
* name = "HepBAdultForecastingPDM41"
...
* action
  * title = "Hep B Immunization Forecast 41"
