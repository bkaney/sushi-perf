...
Instance: HepBAdultForecastingPD239
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 239"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM239"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM239"
* name = "HepBAdultForecastingPDM239"
...
* action
  * title = "Hep B Immunization Forecast 239"
