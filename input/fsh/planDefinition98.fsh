...
Instance: HepBAdultForecastingPD98
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 98"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM98"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM98"
* name = "HepBAdultForecastingPDM98"
...
* action
  * title = "Hep B Immunization Forecast 98"
