...
Instance: HepBAdultForecastingPD235
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 235"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM235"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM235"
* name = "HepBAdultForecastingPDM235"
...
* action
  * title = "Hep B Immunization Forecast 235"
