...
Instance: HepBAdultForecastingPD217
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 217"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM217"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM217"
* name = "HepBAdultForecastingPDM217"
...
* action
  * title = "Hep B Immunization Forecast 217"
