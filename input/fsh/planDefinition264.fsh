...
Instance: HepBAdultForecastingPD264
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 264"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM264"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM264"
* name = "HepBAdultForecastingPDM264"
...
* action
  * title = "Hep B Immunization Forecast 264"
