...
Instance: HepBAdultForecastingPD53
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 53"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM53"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM53"
* name = "HepBAdultForecastingPDM53"
...
* action
  * title = "Hep B Immunization Forecast 53"
