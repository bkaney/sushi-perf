...
Instance: HepBAdultForecastingPD254
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 254"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM254"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM254"
* name = "HepBAdultForecastingPDM254"
...
* action
  * title = "Hep B Immunization Forecast 254"
