...
Instance: HepBAdultForecastingPD284
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 284"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM284"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM284"
* name = "HepBAdultForecastingPDM284"
...
* action
  * title = "Hep B Immunization Forecast 284"
