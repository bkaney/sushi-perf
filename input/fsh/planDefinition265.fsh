...
Instance: HepBAdultForecastingPD265
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 265"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM265"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM265"
* name = "HepBAdultForecastingPDM265"
...
* action
  * title = "Hep B Immunization Forecast 265"
