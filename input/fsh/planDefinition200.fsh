...
Instance: HepBAdultForecastingPD200
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 200"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM200"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM200"
* name = "HepBAdultForecastingPDM200"
...
* action
  * title = "Hep B Immunization Forecast 200"
