...
Instance: HepBAdultForecastingPD61
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 61"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM61"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM61"
* name = "HepBAdultForecastingPDM61"
...
* action
  * title = "Hep B Immunization Forecast 61"
