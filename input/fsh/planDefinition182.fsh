...
Instance: HepBAdultForecastingPD182
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 182"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM182"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM182"
* name = "HepBAdultForecastingPDM182"
...
* action
  * title = "Hep B Immunization Forecast 182"
