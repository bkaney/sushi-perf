...
Instance: HepBAdultForecastingPD213
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 213"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM213"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM213"
* name = "HepBAdultForecastingPDM213"
...
* action
  * title = "Hep B Immunization Forecast 213"
