...
Instance: HepBAdultForecastingPD70
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 70"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM70"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM70"
* name = "HepBAdultForecastingPDM70"
...
* action
  * title = "Hep B Immunization Forecast 70"
