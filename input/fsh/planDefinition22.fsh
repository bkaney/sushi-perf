...
Instance: HepBAdultForecastingPD22
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 22"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM22"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM22"
* name = "HepBAdultForecastingPDM22"
...
* action
  * title = "Hep B Immunization Forecast 22"
