...
Instance: HepBAdultForecastingPD293
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 293"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM293"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM293"
* name = "HepBAdultForecastingPDM293"
...
* action
  * title = "Hep B Immunization Forecast 293"
