...
Instance: HepBAdultForecastingPD76
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 76"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM76"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM76"
* name = "HepBAdultForecastingPDM76"
...
* action
  * title = "Hep B Immunization Forecast 76"
