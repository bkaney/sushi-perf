...
Instance: HepBAdultForecastingPD174
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 174"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM174"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM174"
* name = "HepBAdultForecastingPDM174"
...
* action
  * title = "Hep B Immunization Forecast 174"
