...
Instance: HepBAdultForecastingPD204
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 204"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM204"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM204"
* name = "HepBAdultForecastingPDM204"
...
* action
  * title = "Hep B Immunization Forecast 204"
