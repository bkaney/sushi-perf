...
Instance: HepBAdultForecastingPD74
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 74"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM74"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM74"
* name = "HepBAdultForecastingPDM74"
...
* action
  * title = "Hep B Immunization Forecast 74"
