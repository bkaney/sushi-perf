...
Instance: HepBAdultForecastingPD103
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 103"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM103"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM103"
* name = "HepBAdultForecastingPDM103"
...
* action
  * title = "Hep B Immunization Forecast 103"
