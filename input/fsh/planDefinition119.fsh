...
Instance: HepBAdultForecastingPD119
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 119"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM119"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM119"
* name = "HepBAdultForecastingPDM119"
...
* action
  * title = "Hep B Immunization Forecast 119"
