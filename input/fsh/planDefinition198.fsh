...
Instance: HepBAdultForecastingPD198
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 198"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM198"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM198"
* name = "HepBAdultForecastingPDM198"
...
* action
  * title = "Hep B Immunization Forecast 198"
