...
Instance: HepBAdultForecastingPD96
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 96"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM96"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM96"
* name = "HepBAdultForecastingPDM96"
...
* action
  * title = "Hep B Immunization Forecast 96"
