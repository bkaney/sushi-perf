...
Instance: HepBAdultForecastingPD101
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 101"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM101"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM101"
* name = "HepBAdultForecastingPDM101"
...
* action
  * title = "Hep B Immunization Forecast 101"
