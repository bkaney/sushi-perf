...
Instance: HepBAdultForecastingPD228
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 228"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM228"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM228"
* name = "HepBAdultForecastingPDM228"
...
* action
  * title = "Hep B Immunization Forecast 228"
