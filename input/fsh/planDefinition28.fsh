...
Instance: HepBAdultForecastingPD28
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 28"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM28"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM28"
* name = "HepBAdultForecastingPDM28"
...
* action
  * title = "Hep B Immunization Forecast 28"
