...
Instance: HepBAdultForecastingPD223
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 223"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM223"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM223"
* name = "HepBAdultForecastingPDM223"
...
* action
  * title = "Hep B Immunization Forecast 223"
