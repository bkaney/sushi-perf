...
Instance: HepBAdultForecastingPD81
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 81"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM81"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM81"
* name = "HepBAdultForecastingPDM81"
...
* action
  * title = "Hep B Immunization Forecast 81"
