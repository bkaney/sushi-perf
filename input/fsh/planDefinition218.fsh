...
Instance: HepBAdultForecastingPD218
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 218"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM218"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM218"
* name = "HepBAdultForecastingPDM218"
...
* action
  * title = "Hep B Immunization Forecast 218"
