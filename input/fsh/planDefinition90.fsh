...
Instance: HepBAdultForecastingPD90
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 90"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM90"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM90"
* name = "HepBAdultForecastingPDM90"
...
* action
  * title = "Hep B Immunization Forecast 90"
