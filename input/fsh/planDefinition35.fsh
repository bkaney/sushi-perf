...
Instance: HepBAdultForecastingPD35
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 35"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM35"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM35"
* name = "HepBAdultForecastingPDM35"
...
* action
  * title = "Hep B Immunization Forecast 35"
