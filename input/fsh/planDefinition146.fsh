...
Instance: HepBAdultForecastingPD146
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 146"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM146"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM146"
* name = "HepBAdultForecastingPDM146"
...
* action
  * title = "Hep B Immunization Forecast 146"
