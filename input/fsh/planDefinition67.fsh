...
Instance: HepBAdultForecastingPD67
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 67"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM67"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM67"
* name = "HepBAdultForecastingPDM67"
...
* action
  * title = "Hep B Immunization Forecast 67"
