...
Instance: HepBAdultForecastingPD89
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 89"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM89"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM89"
* name = "HepBAdultForecastingPDM89"
...
* action
  * title = "Hep B Immunization Forecast 89"
