...
Instance: HepBAdultForecastingPD138
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 138"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM138"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM138"
* name = "HepBAdultForecastingPDM138"
...
* action
  * title = "Hep B Immunization Forecast 138"
