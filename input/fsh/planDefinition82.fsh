...
Instance: HepBAdultForecastingPD82
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 82"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM82"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM82"
* name = "HepBAdultForecastingPDM82"
...
* action
  * title = "Hep B Immunization Forecast 82"
