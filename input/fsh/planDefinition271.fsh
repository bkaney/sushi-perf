...
Instance: HepBAdultForecastingPD271
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 271"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM271"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM271"
* name = "HepBAdultForecastingPDM271"
...
* action
  * title = "Hep B Immunization Forecast 271"
