...
Instance: HepBAdultForecastingPD194
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 194"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM194"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM194"
* name = "HepBAdultForecastingPDM194"
...
* action
  * title = "Hep B Immunization Forecast 194"
