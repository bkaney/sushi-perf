...
Instance: HepBAdultForecastingPD50
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 50"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM50"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM50"
* name = "HepBAdultForecastingPDM50"
...
* action
  * title = "Hep B Immunization Forecast 50"
