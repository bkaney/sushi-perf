...
Instance: HepBAdultForecastingPD251
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 251"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM251"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM251"
* name = "HepBAdultForecastingPDM251"
...
* action
  * title = "Hep B Immunization Forecast 251"
