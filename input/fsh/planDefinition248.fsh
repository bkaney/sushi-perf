...
Instance: HepBAdultForecastingPD248
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 248"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM248"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM248"
* name = "HepBAdultForecastingPDM248"
...
* action
  * title = "Hep B Immunization Forecast 248"
