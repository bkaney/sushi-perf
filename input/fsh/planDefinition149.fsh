...
Instance: HepBAdultForecastingPD149
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 149"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM149"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM149"
* name = "HepBAdultForecastingPDM149"
...
* action
  * title = "Hep B Immunization Forecast 149"
