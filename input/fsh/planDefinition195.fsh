...
Instance: HepBAdultForecastingPD195
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 195"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM195"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM195"
* name = "HepBAdultForecastingPDM195"
...
* action
  * title = "Hep B Immunization Forecast 195"
