...
Instance: HepBAdultForecastingPD87
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 87"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM87"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM87"
* name = "HepBAdultForecastingPDM87"
...
* action
  * title = "Hep B Immunization Forecast 87"
