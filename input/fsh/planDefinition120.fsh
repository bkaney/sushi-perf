...
Instance: HepBAdultForecastingPD120
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 120"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM120"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM120"
* name = "HepBAdultForecastingPDM120"
...
* action
  * title = "Hep B Immunization Forecast 120"
