...
Instance: HepBAdultForecastingPD183
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 183"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM183"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM183"
* name = "HepBAdultForecastingPDM183"
...
* action
  * title = "Hep B Immunization Forecast 183"
