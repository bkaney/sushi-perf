...
Instance: HepBAdultForecastingPD48
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 48"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM48"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM48"
* name = "HepBAdultForecastingPDM48"
...
* action
  * title = "Hep B Immunization Forecast 48"
