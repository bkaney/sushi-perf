...
Instance: HepBAdultForecastingPD286
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 286"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM286"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM286"
* name = "HepBAdultForecastingPDM286"
...
* action
  * title = "Hep B Immunization Forecast 286"
