...
Instance: HepBAdultForecastingPD188
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 188"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM188"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM188"
* name = "HepBAdultForecastingPDM188"
...
* action
  * title = "Hep B Immunization Forecast 188"
