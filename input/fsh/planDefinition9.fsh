...
Instance: HepBAdultForecastingPD9
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 9"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM9"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM9"
* name = "HepBAdultForecastingPDM9"
...
* action
  * title = "Hep B Immunization Forecast 9"
