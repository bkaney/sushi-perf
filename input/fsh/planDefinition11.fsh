...
Instance: HepBAdultForecastingPD11
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 11"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM11"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM11"
* name = "HepBAdultForecastingPDM11"
...
* action
  * title = "Hep B Immunization Forecast 11"
