...
Instance: HepBAdultForecastingPD18
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 18"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM18"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM18"
* name = "HepBAdultForecastingPDM18"
...
* action
  * title = "Hep B Immunization Forecast 18"
