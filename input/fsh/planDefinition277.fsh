...
Instance: HepBAdultForecastingPD277
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 277"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM277"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM277"
* name = "HepBAdultForecastingPDM277"
...
* action
  * title = "Hep B Immunization Forecast 277"
