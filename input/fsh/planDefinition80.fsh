...
Instance: HepBAdultForecastingPD80
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 80"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM80"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM80"
* name = "HepBAdultForecastingPDM80"
...
* action
  * title = "Hep B Immunization Forecast 80"
