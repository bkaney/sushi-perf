...
Instance: HepBAdultForecastingPD45
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 45"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM45"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM45"
* name = "HepBAdultForecastingPDM45"
...
* action
  * title = "Hep B Immunization Forecast 45"
