...
Instance: HepBAdultForecastingPD221
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 221"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM221"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM221"
* name = "HepBAdultForecastingPDM221"
...
* action
  * title = "Hep B Immunization Forecast 221"
