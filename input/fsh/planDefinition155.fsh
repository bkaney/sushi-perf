...
Instance: HepBAdultForecastingPD155
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 155"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM155"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM155"
* name = "HepBAdultForecastingPDM155"
...
* action
  * title = "Hep B Immunization Forecast 155"
