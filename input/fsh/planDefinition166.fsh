...
Instance: HepBAdultForecastingPD166
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 166"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM166"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM166"
* name = "HepBAdultForecastingPDM166"
...
* action
  * title = "Hep B Immunization Forecast 166"
