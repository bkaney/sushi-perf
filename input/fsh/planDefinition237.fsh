...
Instance: HepBAdultForecastingPD237
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 237"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM237"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM237"
* name = "HepBAdultForecastingPDM237"
...
* action
  * title = "Hep B Immunization Forecast 237"
