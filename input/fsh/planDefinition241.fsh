...
Instance: HepBAdultForecastingPD241
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 241"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM241"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM241"
* name = "HepBAdultForecastingPDM241"
...
* action
  * title = "Hep B Immunization Forecast 241"
