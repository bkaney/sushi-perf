...
Instance: HepBAdultForecastingPD165
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 165"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM165"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM165"
* name = "HepBAdultForecastingPDM165"
...
* action
  * title = "Hep B Immunization Forecast 165"
