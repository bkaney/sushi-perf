...
Instance: HepBAdultForecastingPD100
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 100"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM100"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM100"
* name = "HepBAdultForecastingPDM100"
...
* action
  * title = "Hep B Immunization Forecast 100"
