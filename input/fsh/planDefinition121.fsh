...
Instance: HepBAdultForecastingPD121
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 121"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM121"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM121"
* name = "HepBAdultForecastingPDM121"
...
* action
  * title = "Hep B Immunization Forecast 121"
