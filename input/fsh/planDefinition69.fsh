...
Instance: HepBAdultForecastingPD69
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 69"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM69"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM69"
* name = "HepBAdultForecastingPDM69"
...
* action
  * title = "Hep B Immunization Forecast 69"
