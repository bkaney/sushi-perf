...
Instance: HepBAdultForecastingPD24
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 24"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM24"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM24"
* name = "HepBAdultForecastingPDM24"
...
* action
  * title = "Hep B Immunization Forecast 24"
