...
Instance: HepBAdultForecastingPD27
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 27"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM27"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM27"
* name = "HepBAdultForecastingPDM27"
...
* action
  * title = "Hep B Immunization Forecast 27"
