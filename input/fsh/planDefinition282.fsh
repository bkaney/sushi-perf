...
Instance: HepBAdultForecastingPD282
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 282"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM282"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM282"
* name = "HepBAdultForecastingPDM282"
...
* action
  * title = "Hep B Immunization Forecast 282"
