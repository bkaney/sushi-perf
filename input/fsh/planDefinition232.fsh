...
Instance: HepBAdultForecastingPD232
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 232"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM232"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM232"
* name = "HepBAdultForecastingPDM232"
...
* action
  * title = "Hep B Immunization Forecast 232"
