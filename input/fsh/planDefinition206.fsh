...
Instance: HepBAdultForecastingPD206
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 206"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM206"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM206"
* name = "HepBAdultForecastingPDM206"
...
* action
  * title = "Hep B Immunization Forecast 206"
