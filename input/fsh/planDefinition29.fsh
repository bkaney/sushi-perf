...
Instance: HepBAdultForecastingPD29
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 29"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM29"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM29"
* name = "HepBAdultForecastingPDM29"
...
* action
  * title = "Hep B Immunization Forecast 29"
