...
Instance: HepBAdultForecastingPD5
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 5"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM5"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM5"
* name = "HepBAdultForecastingPDM5"
...
* action
  * title = "Hep B Immunization Forecast 5"
