...
Instance: HepBAdultForecastingPD125
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 125"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM125"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM125"
* name = "HepBAdultForecastingPDM125"
...
* action
  * title = "Hep B Immunization Forecast 125"
