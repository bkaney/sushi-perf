...
Instance: HepBAdultForecastingPD85
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 85"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM85"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM85"
* name = "HepBAdultForecastingPDM85"
...
* action
  * title = "Hep B Immunization Forecast 85"
