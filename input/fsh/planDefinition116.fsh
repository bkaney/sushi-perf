...
Instance: HepBAdultForecastingPD116
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 116"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM116"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM116"
* name = "HepBAdultForecastingPDM116"
...
* action
  * title = "Hep B Immunization Forecast 116"
