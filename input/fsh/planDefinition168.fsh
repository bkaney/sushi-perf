...
Instance: HepBAdultForecastingPD168
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 168"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM168"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM168"
* name = "HepBAdultForecastingPDM168"
...
* action
  * title = "Hep B Immunization Forecast 168"
