...
Instance: HepBAdultForecastingPD40
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 40"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM40"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM40"
* name = "HepBAdultForecastingPDM40"
...
* action
  * title = "Hep B Immunization Forecast 40"
