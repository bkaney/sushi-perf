...
Instance: HepBAdultForecastingPD143
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 143"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM143"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM143"
* name = "HepBAdultForecastingPDM143"
...
* action
  * title = "Hep B Immunization Forecast 143"
