...
Instance: HepBAdultForecastingPD291
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 291"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM291"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM291"
* name = "HepBAdultForecastingPDM291"
...
* action
  * title = "Hep B Immunization Forecast 291"
