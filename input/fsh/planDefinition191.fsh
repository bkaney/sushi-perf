...
Instance: HepBAdultForecastingPD191
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 191"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM191"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM191"
* name = "HepBAdultForecastingPDM191"
...
* action
  * title = "Hep B Immunization Forecast 191"
