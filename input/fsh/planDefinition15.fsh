...
Instance: HepBAdultForecastingPD15
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 15"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM15"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM15"
* name = "HepBAdultForecastingPDM15"
...
* action
  * title = "Hep B Immunization Forecast 15"
