...
Instance: HepBAdultForecastingPD173
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 173"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM173"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM173"
* name = "HepBAdultForecastingPDM173"
...
* action
  * title = "Hep B Immunization Forecast 173"
