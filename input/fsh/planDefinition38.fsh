...
Instance: HepBAdultForecastingPD38
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 38"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM38"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM38"
* name = "HepBAdultForecastingPDM38"
...
* action
  * title = "Hep B Immunization Forecast 38"
