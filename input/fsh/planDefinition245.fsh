...
Instance: HepBAdultForecastingPD245
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 245"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM245"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM245"
* name = "HepBAdultForecastingPDM245"
...
* action
  * title = "Hep B Immunization Forecast 245"
