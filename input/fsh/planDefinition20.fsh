...
Instance: HepBAdultForecastingPD20
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 20"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM20"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM20"
* name = "HepBAdultForecastingPDM20"
...
* action
  * title = "Hep B Immunization Forecast 20"
