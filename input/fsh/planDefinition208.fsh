...
Instance: HepBAdultForecastingPD208
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 208"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM208"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM208"
* name = "HepBAdultForecastingPDM208"
...
* action
  * title = "Hep B Immunization Forecast 208"
