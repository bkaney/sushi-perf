...
Instance: HepBAdultForecastingPD122
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 122"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM122"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM122"
* name = "HepBAdultForecastingPDM122"
...
* action
  * title = "Hep B Immunization Forecast 122"
