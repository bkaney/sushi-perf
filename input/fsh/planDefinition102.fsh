...
Instance: HepBAdultForecastingPD102
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 102"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM102"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM102"
* name = "HepBAdultForecastingPDM102"
...
* action
  * title = "Hep B Immunization Forecast 102"
