...
Instance: HepBAdultForecastingPD160
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 160"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM160"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM160"
* name = "HepBAdultForecastingPDM160"
...
* action
  * title = "Hep B Immunization Forecast 160"
