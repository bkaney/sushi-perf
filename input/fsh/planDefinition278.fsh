...
Instance: HepBAdultForecastingPD278
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 278"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM278"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM278"
* name = "HepBAdultForecastingPDM278"
...
* action
  * title = "Hep B Immunization Forecast 278"
