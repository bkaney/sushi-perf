...
Instance: HepBAdultForecastingPD151
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 151"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM151"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM151"
* name = "HepBAdultForecastingPDM151"
...
* action
  * title = "Hep B Immunization Forecast 151"
