...
Instance: HepBAdultForecastingPD244
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 244"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM244"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM244"
* name = "HepBAdultForecastingPDM244"
...
* action
  * title = "Hep B Immunization Forecast 244"
