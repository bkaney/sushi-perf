...
Instance: HepBAdultForecastingPD10
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 10"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM10"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM10"
* name = "HepBAdultForecastingPDM10"
...
* action
  * title = "Hep B Immunization Forecast 10"
