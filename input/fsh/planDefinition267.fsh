...
Instance: HepBAdultForecastingPD267
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 267"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM267"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM267"
* name = "HepBAdultForecastingPDM267"
...
* action
  * title = "Hep B Immunization Forecast 267"
