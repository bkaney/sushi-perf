...
Instance: HepBAdultForecastingPD238
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 238"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM238"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM238"
* name = "HepBAdultForecastingPDM238"
...
* action
  * title = "Hep B Immunization Forecast 238"
