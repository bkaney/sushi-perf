...
Instance: HepBAdultForecastingPD220
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 220"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM220"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM220"
* name = "HepBAdultForecastingPDM220"
...
* action
  * title = "Hep B Immunization Forecast 220"
