...
Instance: HepBAdultForecastingPD202
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 202"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM202"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM202"
* name = "HepBAdultForecastingPDM202"
...
* action
  * title = "Hep B Immunization Forecast 202"
