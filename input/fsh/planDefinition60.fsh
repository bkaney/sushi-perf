...
Instance: HepBAdultForecastingPD60
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 60"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM60"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM60"
* name = "HepBAdultForecastingPDM60"
...
* action
  * title = "Hep B Immunization Forecast 60"
