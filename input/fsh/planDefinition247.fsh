...
Instance: HepBAdultForecastingPD247
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 247"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM247"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM247"
* name = "HepBAdultForecastingPDM247"
...
* action
  * title = "Hep B Immunization Forecast 247"
