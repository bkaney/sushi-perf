...
Instance: HepBAdultForecastingPD6
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 6"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM6"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM6"
* name = "HepBAdultForecastingPDM6"
...
* action
  * title = "Hep B Immunization Forecast 6"
