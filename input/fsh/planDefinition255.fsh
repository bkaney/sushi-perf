...
Instance: HepBAdultForecastingPD255
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 255"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM255"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM255"
* name = "HepBAdultForecastingPDM255"
...
* action
  * title = "Hep B Immunization Forecast 255"
