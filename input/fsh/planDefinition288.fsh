...
Instance: HepBAdultForecastingPD288
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 288"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM288"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM288"
* name = "HepBAdultForecastingPDM288"
...
* action
  * title = "Hep B Immunization Forecast 288"
