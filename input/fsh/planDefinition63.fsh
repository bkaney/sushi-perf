...
Instance: HepBAdultForecastingPD63
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 63"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM63"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM63"
* name = "HepBAdultForecastingPDM63"
...
* action
  * title = "Hep B Immunization Forecast 63"
