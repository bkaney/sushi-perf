...
Instance: HepBAdultForecastingPD211
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 211"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM211"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM211"
* name = "HepBAdultForecastingPDM211"
...
* action
  * title = "Hep B Immunization Forecast 211"
