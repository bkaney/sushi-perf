...
Instance: HepBAdultForecastingPD131
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 131"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM131"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM131"
* name = "HepBAdultForecastingPDM131"
...
* action
  * title = "Hep B Immunization Forecast 131"
