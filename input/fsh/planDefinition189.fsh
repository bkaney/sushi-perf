...
Instance: HepBAdultForecastingPD189
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 189"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM189"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM189"
* name = "HepBAdultForecastingPDM189"
...
* action
  * title = "Hep B Immunization Forecast 189"
