...
Instance: HepBAdultForecastingPD83
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 83"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM83"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM83"
* name = "HepBAdultForecastingPDM83"
...
* action
  * title = "Hep B Immunization Forecast 83"
