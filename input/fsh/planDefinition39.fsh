...
Instance: HepBAdultForecastingPD39
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 39"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM39"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM39"
* name = "HepBAdultForecastingPDM39"
...
* action
  * title = "Hep B Immunization Forecast 39"
