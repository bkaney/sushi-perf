...
Instance: HepBAdultForecastingPD46
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 46"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM46"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM46"
* name = "HepBAdultForecastingPDM46"
...
* action
  * title = "Hep B Immunization Forecast 46"
