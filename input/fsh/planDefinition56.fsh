...
Instance: HepBAdultForecastingPD56
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 56"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM56"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM56"
* name = "HepBAdultForecastingPDM56"
...
* action
  * title = "Hep B Immunization Forecast 56"
