...
Instance: HepBAdultForecastingPD135
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 135"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM135"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM135"
* name = "HepBAdultForecastingPDM135"
...
* action
  * title = "Hep B Immunization Forecast 135"
