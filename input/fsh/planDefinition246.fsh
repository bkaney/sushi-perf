...
Instance: HepBAdultForecastingPD246
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 246"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM246"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM246"
* name = "HepBAdultForecastingPDM246"
...
* action
  * title = "Hep B Immunization Forecast 246"
