...
Instance: HepBAdultForecastingPD52
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 52"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM52"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM52"
* name = "HepBAdultForecastingPDM52"
...
* action
  * title = "Hep B Immunization Forecast 52"
