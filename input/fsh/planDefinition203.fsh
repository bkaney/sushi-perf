...
Instance: HepBAdultForecastingPD203
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 203"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM203"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM203"
* name = "HepBAdultForecastingPDM203"
...
* action
  * title = "Hep B Immunization Forecast 203"
