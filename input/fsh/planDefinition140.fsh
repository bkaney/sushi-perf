...
Instance: HepBAdultForecastingPD140
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 140"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM140"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM140"
* name = "HepBAdultForecastingPDM140"
...
* action
  * title = "Hep B Immunization Forecast 140"
