...
Instance: HepBAdultForecastingPD167
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 167"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM167"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM167"
* name = "HepBAdultForecastingPDM167"
...
* action
  * title = "Hep B Immunization Forecast 167"
