...
Instance: HepBAdultForecastingPD279
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 279"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM279"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM279"
* name = "HepBAdultForecastingPDM279"
...
* action
  * title = "Hep B Immunization Forecast 279"
