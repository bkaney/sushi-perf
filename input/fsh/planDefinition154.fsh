...
Instance: HepBAdultForecastingPD154
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 154"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM154"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM154"
* name = "HepBAdultForecastingPDM154"
...
* action
  * title = "Hep B Immunization Forecast 154"
