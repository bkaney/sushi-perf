...
Instance: HepBAdultForecastingPD88
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 88"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM88"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM88"
* name = "HepBAdultForecastingPDM88"
...
* action
  * title = "Hep B Immunization Forecast 88"
