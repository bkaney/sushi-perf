...
Instance: HepBAdultForecastingPD110
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 110"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM110"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM110"
* name = "HepBAdultForecastingPDM110"
...
* action
  * title = "Hep B Immunization Forecast 110"
