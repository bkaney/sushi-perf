...
Instance: HepBAdultForecastingPD148
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 148"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM148"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM148"
* name = "HepBAdultForecastingPDM148"
...
* action
  * title = "Hep B Immunization Forecast 148"
