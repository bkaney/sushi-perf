...
Instance: HepBAdultForecastingPD197
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 197"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM197"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM197"
* name = "HepBAdultForecastingPDM197"
...
* action
  * title = "Hep B Immunization Forecast 197"
