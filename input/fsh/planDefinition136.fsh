...
Instance: HepBAdultForecastingPD136
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 136"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM136"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM136"
* name = "HepBAdultForecastingPDM136"
...
* action
  * title = "Hep B Immunization Forecast 136"
