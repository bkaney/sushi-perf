...
Instance: HepBAdultForecastingPD0
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 0"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM0"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM0"
* name = "HepBAdultForecastingPDM0"
...
* action
  * title = "Hep B Immunization Forecast 0"
