...
Instance: HepBAdultForecastingPD108
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 108"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM108"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM108"
* name = "HepBAdultForecastingPDM108"
...
* action
  * title = "Hep B Immunization Forecast 108"
