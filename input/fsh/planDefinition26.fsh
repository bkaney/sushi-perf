...
Instance: HepBAdultForecastingPD26
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 26"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM26"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM26"
* name = "HepBAdultForecastingPDM26"
...
* action
  * title = "Hep B Immunization Forecast 26"
