...
Instance: HepBAdultForecastingPD176
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 176"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM176"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM176"
* name = "HepBAdultForecastingPDM176"
...
* action
  * title = "Hep B Immunization Forecast 176"
