...
Instance: HepBAdultForecastingPD192
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 192"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM192"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM192"
* name = "HepBAdultForecastingPDM192"
...
* action
  * title = "Hep B Immunization Forecast 192"
