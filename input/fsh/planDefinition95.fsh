...
Instance: HepBAdultForecastingPD95
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 95"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM95"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM95"
* name = "HepBAdultForecastingPDM95"
...
* action
  * title = "Hep B Immunization Forecast 95"
