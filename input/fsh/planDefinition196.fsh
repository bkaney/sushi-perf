...
Instance: HepBAdultForecastingPD196
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 196"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM196"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM196"
* name = "HepBAdultForecastingPDM196"
...
* action
  * title = "Hep B Immunization Forecast 196"
