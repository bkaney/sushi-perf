...
Instance: HepBAdultForecastingPD17
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 17"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM17"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM17"
* name = "HepBAdultForecastingPDM17"
...
* action
  * title = "Hep B Immunization Forecast 17"
