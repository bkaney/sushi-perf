...
Instance: HepBAdultForecastingPD72
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 72"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM72"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM72"
* name = "HepBAdultForecastingPDM72"
...
* action
  * title = "Hep B Immunization Forecast 72"
