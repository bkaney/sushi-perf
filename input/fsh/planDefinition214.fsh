...
Instance: HepBAdultForecastingPD214
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 214"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM214"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM214"
* name = "HepBAdultForecastingPDM214"
...
* action
  * title = "Hep B Immunization Forecast 214"
