...
Instance: HepBAdultForecastingPD180
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 180"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM180"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM180"
* name = "HepBAdultForecastingPDM180"
...
* action
  * title = "Hep B Immunization Forecast 180"
