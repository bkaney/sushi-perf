...
Instance: HepBAdultForecastingPD51
InstanceOf: PlanDefinition
Usage: #definition
Title: "Immunization Forecasting of Hepatitis B Vaccine for Adults >= 18 Years of Age 51"
* identifier
  * use = #official
  * value = "HepBAdultForecastingPDM51"
* status = #draft
* experimental = true
* url = "http://hl7.org/fhir/uv/cpg/hepb/PlanDefinition/HepBAdultForecastingPDM51"
* name = "HepBAdultForecastingPDM51"
...
* action
  * title = "Hep B Immunization Forecast 51"
